...
public class MainActivity extends AppCompatActivity {
    ...
    ViewFlipper vfp;
    Dialog mydialog;
    LinearLayout lay_acc,lay_pag,lay_con;
    CustomerDialog cd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void dailog_acc(View view){
            lay_acc=findViewById(R.id.linear1);
            startActivity(new Intent(MainActivity.this,ChartActivity.class));
            mydialog.show();
        }
    public void dailog_pag(View view){
        lay_pag=findViewById(R.id.linear2);
        startActivity(new Intent(MainActivity.this,ChartActivity.class));
        mydialog.show();
    }
    public void dailog_con(View view){
        lay_con=findViewById(R.id.linear3);
        startActivity(new Intent(MainActivity.this,ChartActivity.class));
        mydialog.show();
    }
